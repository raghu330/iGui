...
opPath = '/gpfs2/home/umtid/test/GRIBs/'
...
def main():
    ...
    for fnames in fnames1:
        ...
        # open loop-2
        cntr = 1
        # open for-loop-2 -- works on all the forecast times
        for lol in ['000','024','048','072','096','120','144','168','192','216']:
            fname = fnames+lol
            ...
            for ii in range(len(varIdx)):
                ...
                # open for-loop-3 -- runs through the selected time slices - synop hours
                for jj in timeIndx:
